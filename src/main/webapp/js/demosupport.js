...
//**************Initialize variables******************************/
  ...
  wsUri = "ws://" + window.location.hostname  + ":7001/ws/webrtc/guest";
  loginUri = "http://" + window.location.hostname + ":8080/wscsample/index.html";
  logoutUri = "http://" + window.location.hostname + ":7001/logout?redirect_uri=" + loginUri;
  //**************Initailize Session******************/
...
//    wscSession.setReconnectTime(60 * 1000);
  ...
  function initalizeRegisterUI() {
    var wsHtml = "<div align=center'> <span style='font-size:14px;'>WebSocket URL: </span><input type='text' name='wsUrl' value='ws://ocwsc71se.optaresolutions.com:7001/ws/webrtc/guest' id='wsUrl' size='50'/><input type='button' id='saveWSUrl' value='Save WebSocket URL' onclick='saveWSUrl()' /><span style='color:gray;font-size:14px;'>Format: 'ws://[IP Address]:[Port]/[Path]'    Example: ws://ocwsc71se.optaresolutions.com:7001/ws/webrtc/guest</span></div>";
